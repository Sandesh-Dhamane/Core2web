#Develop a PyQt application with a QMainWindow that contains a QMenuBar. Include at least two menus with corresponding actions, and display appropriate messages when actions are triggered.
