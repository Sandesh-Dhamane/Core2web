#Create a PyQt window with a progress bar. Implement a function that simulates a task (e.g., file download) and updates the progress bar accordingly.
...
class ProgressBar(QWidget):
    ...
    def Download(self):
        ...
        save_loc ='c:/Users/sande/OneDrive/Desktop/Assignment Python.jpeg'
